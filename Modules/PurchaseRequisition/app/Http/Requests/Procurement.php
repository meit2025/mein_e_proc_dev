...
class Procurement extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'vendors.*.units.*.cost_center' => 'required',
            'vendors.*.units.*.material_group' => 'required|string|max:255',
            'vendors.*.units.*.material_number' => 'required|string|max:255',
            ...
            'vendors.*.units.*.order_number' => 'required|string|max:20',
            'vendors.*.units.*.asset_number' => 'required|string|max:20',
            'vendors.*.units.*.sub_asset_number' => 'required|string|max:20',
        ];
    }
