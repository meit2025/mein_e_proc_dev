            ...
            >
              ...
              >
                <div className='menu-item active'>
                  <a
                    className='menu-link text-nowrap text-sm text-gray-800 font-medium menu-item-hover:text-primary menu-item-active:text-gray-900 menu-item-active:font-medium'
                ...
                >
                  <div className='menu-link text-sm text-gray-800 menu-link-hover:text-primary menu-item-active:text-gray-900 menu-item-show:text-primary menu-item-here:text-gray-900 menu-item-active:font-medium menu-item-here:font-medium'>
                    <span className='menu-title text-nowrap'>Profiles</span>
                            ...
                            <div>
                              ...
                              <div className='menu-item'>
                                <a className='menu-link' href='#' tabIndex={0}>
                                  ...
                                  <span className='menu-title grow-0'>Freelancer</span>
                            ...
                            <div className='flex flex-col'>
                              <div className='menu-item'>
                                ...
                                >
                                  ...
                                  <span className='menu-title grow-0'>Projects - 3 Columns</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                                ...
                                >
                                  ...
                                  <span className='menu-title grow-0'>Projects - 2 Columns</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                              ...
                              <div className='menu-item'>
                                ...
                                >
                                  ...
                                  <span className='menu-title grow-0'>Campaigns - Card</span>
                                </a>
                              </div>
                            </div>
                            <div>
                              <div className='menu-item'>
                                ...
                                >
                                  ...
                                  <span className='menu-title grow-0'>Campaigns - List</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                                ...
                                >
                                  ...
                                  <span className='menu-title grow-0'>Empty Page</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a className='menu-link' href='#' tabIndex={0}>
                          ...
                          <div className='menu menu-default menu-fit flex-col'>
                            ...
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>User Profile</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Company Profile</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>With Sidebar</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                          ...
                          <div className='menu menu-default menu-fit flex-col'>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Basic Billing</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                            ...
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Billing History</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a className='menu-link' href='#' tabIndex={0}>
                          ...
                          <div className='menu menu-default menu-fit flex-col'>
                            ...
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Security Overview</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>IP Addresses</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Privacy Settings</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Device Management</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Backup & Recovery</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Current Sessions</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Security Log</span>
                              </a>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className='menu menu-default menu-fit flex-col'>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Teams Starter</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                            ...
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Members Starter</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Team Members</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Import Members</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                            ...
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Persmissions - Toggler</span>
                              </a>
                            </div>
                            <div className='menu-item'>
                              <a
                                ...
                                tabIndex={0}
                              >
                                <span className='menu-title grow-0'>Persmissions - Check</span>
                              </a>
                            </div>
                          </div>
                        </div>
                            ...
                            <div className='menu menu-default menu-fit flex-col'>
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>Mini Cards</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                              ...
                              <div className='menu-item'>
                                <a className='menu-link' href='#' tabIndex={0}>
                                  <span className='menu-title grow-0'>Social Users</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a className='menu-link' href='#' tabIndex={0}>
                            ...
                            <div className='menu menu-default menu-fit flex-col'>
                              ...
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>App Roster</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>Market Authors</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>SaaS Users</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>Store Clients</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                            ...
                            <div className='menu menu-default menu-fit flex-col'>
                              ...
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>Check Email</span>
                                </a>
                              </div>
                              ...
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>Enter Email</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                              ...
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>Change Password</span>
                                </a>
                              </div>
                              <div className='menu-item'>
                                <a
                                  ...
                                  tabIndex={0}
                                >
                                  <span className='menu-title grow-0'>Password is Changed</span>
                                </a>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className='menu menu-default menu-fit flex-col'>
                          <div className='menu-item'>
                            ...
                            >
                              ...
                              <span className='menu-title grow-0'>Welcome Message</span>
                            </a>
                          </div>
                          <div className='menu-item'>
                            <a
                            ...
                            >
                              ...
                              <span className='menu-title grow-0'>Account Deactivated</span>
                            </a>
                          </div>
                          <div className='menu-item'>
                            <a
                      ...
                      <div className='menu-dropdown menu-default w-full max-w-[175px] lg:max-w-[220px]'>
                        ...
                        <div className='menu-item'>
                          ...
                          >
                            ...
                            <span className='menu-title grow-0'>Popular Questions</span>
                          </a>
                        </div>
                        <div className='menu-item'>
                          <a
                  ...
                  <div className='flex items-center justify-between flex-wrap gap-2 px-5'>
                    <div className='flex items-center flex-wrap gap-2'>
                      <div className='flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-11'>
                        <img alt='' className='size-7' src='assets/media/brand-logos/gitlab.svg' />
                      </div>
                      <div className='flex flex-col'>
                        <a
                ...
                <div className='flex flex-col gap-5 py-5'>
                  <div className='flex items-end gap-3.5 px-5'>
                    ...
                    <div className='flex flex-col gap-1.5'>
                      ...
                      <span className='text-2xs font-medium text-gray-500'>14:04</span>
                    </div>
                  </div>
                  <div className='flex items-end justify-end gap-3.5 px-5'>
                    <div className='flex flex-col gap-1.5'>
                      <div className='card shadow-none flex bg-primary flex-col gap-2.5 p-3 rounded-br-none'>
                        <p className='text-2sm font-medium text-light'>This is excellent news!</p>
                      </div>
                      <div className='flex items-center justify-end relative'>
                        <span className='text-2xs font-medium text-gray-600 mr-6'>14:08</span>
                  ...
                  <div className='flex items-end gap-3.5 px-5'>
                    ...
                    <div className='flex flex-col gap-1.5'>
                      ...
                      <span className='text-2xs font-medium text-gray-500'>14:26</span>
                    </div>
                  </div>
                  <div className='flex items-end gap-3.5 px-5'>
                    <img
                    ...
                    <div className='flex flex-col gap-1.5'>
                      ...
                      <span className='text-2xs font-medium text-gray-500'>15:09</span>
                    </div>
                  </div>
                  <div className='flex items-end justify-end gap-3.5 px-5'>
                    <div className='flex flex-col gap-1.5'>
                      ...
                      <div className='flex items-center justify-end relative'>
                        <span className='text-2xs font-medium text-gray-600 mr-6'>15:52</span>
                  ...
                  <div className='flex items-end justify-end gap-3.5 px-5'>
                    <div className='flex flex-col gap-1.5'>
                      <div className='card shadow-none flex bg-primary flex-col gap-2.5 p-3 rounded-br-none'>
                        <p className='text-2sm font-medium text-light'>Checking the build now</p>
                      </div>
                      <div className='flex items-center justify-end relative'>
                        <span className='text-2xs font-medium text-gray-600 mr-6'>15:52</span>
                        <i className='ki-filled ki-double-check text-lg absolute text-gray-400'></i>
                  ...
                  <div className='flex items-end gap-3.5 px-5'>
                    ...
                    <div className='flex flex-col gap-1.5'>
                      ...
                      <span className='text-2xs font-medium text-gray-500'>17:40</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className='dropdown-content light:border-gray-300 w-screen max-w-[320px]'>
              ...
              <div className='flex flex-col scrollable-y-auto max-h-[400px] divide-y divide-gray-200'>
                <div className='flex items-center justify-between flex-wrap gap-2 px-5 py-3.5'>
                  <div className='flex items-center flex-wrap gap-2'>
                    <div className='flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10'>
                      <img alt='' className='size-6' src='assets/media/brand-logos/jira.svg' />
                    </div>
                    <div className='flex flex-col'>
                      <a
                        className='text-2sm font-semibold text-gray-900 hover:text-primary-active'
                ...
                <div className='flex items-center justify-between flex-wrap gap-2 px-5 py-3.5'>
                  <div className='flex items-center flex-wrap gap-2'>
                    <div className='flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10'>
                      <img alt='' className='size-6' src='assets/media/brand-logos/inferno.svg' />
                    </div>
                    <div className='flex flex-col'>
                      <a
                        className='text-2sm font-semibold text-gray-900 hover:text-primary-active'
                ...
                <div className='flex items-center justify-between flex-wrap gap-2 px-5 py-3.5'>
                  <div className='flex items-center flex-wrap gap-2'>
                    <div className='flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10'>
                      <img alt='' className='size-6' src='assets/media/brand-logos/evernote.svg' />
                    </div>
                    <div className='flex flex-col'>
                      <a
                        className='text-2sm font-semibold text-gray-900 hover:text-primary-active'
                ...
                <div className='flex items-center justify-between flex-wrap gap-2 px-5 py-3.5'>
                  <div className='flex items-center flex-wrap gap-2'>
                    <div className='flex items-center justify-center shrink-0 rounded-full bg-gray-100 border border-gray-200 size-10'>
                      <img alt='' className='size-6' src='assets/media/brand-logos/gitlab.svg' />
                    </div>
                    <div className='flex flex-col'>
                      <a
                        className='text-2sm font-semibold text-gray-900 hover:text-primary-active'
                      ...
                      <span className='text-2xs font-medium text-gray-600'>DevOps platform</span>
                    </div>
                  </div>
                  <div className='flex items-center gap-2 lg:gap-5'>
                    <label className='switch switch-sm'>
                        ...
                        <div className='flex flex-col gap-3.5'>
                          <div className='flex flex-col gap-1'>
                            <div className='text-2sm font-medium mb-px'>
                              ...
                              <span className='text-gray-700'>requested access to</span>
                              <a className='hover:text-primary-active text-primary' href='#'>
                                AirSpace
                              </a>
                      ...
                      <div className='flex grow gap-2.5 px-5'>
                        ...
                        <div className='flex flex-col gap-3.5 grow'>
                          ...
                          <div className='card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-light-active'>
                            <img className='h-5' src='assets/media/file-types/pdf.svg' />
                            <a
                      ...
                      <div className='flex grow gap-2.5 px-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                          <div className='text-2sm font-medium mb-px'>
                            ...
                            <span className='text-gray-700'>posted a new article</span>
                            <a className='hover:text-primary-active text-primary' href='#'>
                              2024 Roadmap
                            </a>
                          </div>
                        ...
                        <div className='flex flex-col gap-3.5 grow'>
                          ...
                          <div className='card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-light-active'>
                            <div className='flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-light rounded border border-gray-200'>
                              <img className='h-5' src='assets/media/file-types/figma.svg' />
                            </div>
                            <a
                              className='hover:text-primary-active font-medium text-gray-700 text-xs me-1'
                              href='#'
                        ...
                        <div className='flex flex-col gap-3.5 grow'>
                          ...
                          <div className='card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-light-active'>
                            <div className='flex items-center gap-1.5'>
                              <img className='h-6' src='assets/media/file-types/xls.svg' />
                        ...
                        <div className='flex flex-col gap-3.5'>
                          <div className='flex flex-col gap-1'>
                            <div className='text-2sm font-medium mb-px'>
                              ...
                              <span className='text-gray-700'>requested to upgrade plan</span>
                              <a className='hover:text-primary-active text-primary' href='#'></a>
                    ...
                    <div className='flex flex-col gap-5 pt-3 pb-4'>
                      ...
                      <div className='flex grow gap-2.5 px-5'>
                        ...
                        <div className='flex flex-col gap-1'>
                          <div className='text-2sm font-medium mb-px'>
                            ...
                            <span className='text-gray-700'>change the due date of</span>
                            <a className='hover:text-primary-active text-primary' href='#'>
                              Marketing
                            </a>
                            to 13 May
                      ...
                      <div className='flex grow gap-2.5 px-5'>
                        ...
                        <div className='flex flex-col gap-3.5 grow'>
                          ...
                          <div className='card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-light-active'>
                            <div className='flex items-center gap-1.5'>
                              <img className='h-6' src='assets/media/file-types/word.svg' />
                              <div className='flex flex-col gap-0.5'>
                                <a
                                  className='hover:text-primary-active font-medium text-gray-700 text-xs'
                                  href='#'
                          ...
                          <div className='card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-light-active'>
                            <div className='flex items-center gap-1.5'>
                              <img className='h-6' src='assets/media/file-types/svg.svg' />
                              <div className='flex flex-col gap-0.5'>
                                <a
                                  className='hover:text-primary-active font-medium text-gray-700 text-xs'
                                  href='#'
                          ...
                          <div className='card shadow-none flex flex-col gap-2.5 p-3.5 rounded-lg bg-light-active'>
                            <div className='text-2sm font-semibold text-gray-600 mb-px'>
                              ...
                              <span className='text-gray-700 font-medium'>
                                This design is simply stunning! From layout to color, it`s a work of
                                art!
                              </span>
                            </div>
                        ...
                        <div className='flex flex-col gap-3.5'>
                          <div className='flex flex-col gap-1'>
                            <div className='text-2sm font-medium mb-px'>
                              ...
                              <span className='text-gray-700'>has invited you to join</span>
                              <a className='hover:text-primary-active text-primary' href='#'>
                                Design Research
                              </a>
                              <span className='text-gray-700'></span>
                  ...
                  >
                    <div className='flex flex-col gap-5 pt-3 pb-4'>
                            ...
                            <div className='card shadow-none flex flex-col gap-3.5 bg-light-active w-40'>
                              ...
                              <div className='px-2.5 pb-2'>
                                ...
                                <div className='text-2xs font-medium text-gray-500'>
                                  Token ID:
                                  <span className='text-2xs font-medium text-gray-700'>81023</span>
                                </div>
                              </div>
                            </div>
                            <div className='card shadow-none flex flex-col gap-3.5 bg-light-active w-40'>
                              ...
                              <div className='px-2.5 pb-2'>
                                ...
                                <div className='text-2xs font-medium text-gray-500'>
                                  Token ID:
                                  <span className='text-2xs font-medium text-gray-700'>67890</span>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className='flex grow gap-2.5 px-5' id='notification_request_3'>
                        ...
                        <div className='flex flex-col gap-2.5 grow' id='notification_request_17'>
                          <div className='flex flex-col gap-1 mb-1'>
                            <div className='text-2sm font-medium mb-px'>
                              <a
                                className='hover:text-primary-active text-gray-900 font-semibold'
                          ...
                          <div className='card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-light-active'>
                            <div className='flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-white rounded border border-gray-200'>
                              <img className='h-5' src='assets/media/brand-logos/jira.svg' />
                            </div>
                            <a
                              className='hover:text-primary-active font-medium text-gray-700 text-xs me-1'
                              href='#'
                        ...
                        <div className='flex flex-col gap-2.5 grow'>
                          <div className='flex flex-col gap-1 mb-1'>
                            <div className='text-2sm font-medium mb-px'>
                              ...
                              <span className='text-gray-700'>requested to view</span>
                            </div>
                            <span className='flex items-center text-2xs font-medium text-gray-500'>
                              3 day ago
                              <span className='badge badge-circle bg-gray-500 size-1 mx-1.5'></span>
