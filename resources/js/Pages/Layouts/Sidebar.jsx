          ...
          >
            ...
            >
              ...
              <div className='menu-accordion gap-0.5 pl-[10px] relative before:absolute before:left-[20px] before:top-0 before:bottom-0 before:border-l before:border-gray-200'>
                ...
                >
                  ...
                  >
                    <span className='menu-bullet flex w-[6px] relative before:absolute before:top-0 before:size-[6px] before:rounded-full before:-translate-x-1/2 before:-translate-y-1/2 menu-item-active:before:bg-primary menu-item-hover:before:bg-primary'></span>
                    <span className='menu-title text-2sm font-normal mr-1 text-gray-800 menu-item-active:text-primary menu-item-active:font-medium menu-link-hover:!text-primary'>
                      Profiles
                    </span>
                    <span className='menu-arrow text-gray-400 w-[20px] shrink-0 justify-end ml-1 mr-[-10px]'>
                      <i className='ki-filled ki-plus text-2xs menu-item-show:hidden'></i>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className='menu-title text-2sm font-normal text-gray-600 dark:text-gray-500'>
                          ...
                          <span className='flex menu-item-show:hidden'>Show 4 more</span>
                        </span>
                        <span className='menu-arrow text-gray-400 w-[20px] shrink-0 justify-end ml-1 mr-[-10px]'>
                          <i className='ki-filled ki-plus text-2xs menu-item-show:hidden'></i>
                          <i className='ki-filled ki-minus text-2xs hidden menu-item-show:inline-flex'></i>
            ...
            >
              ...
              <div className='menu-accordion gap-0.5 pl-[10px] relative before:absolute before:left-[20px] before:top-0 before:bottom-0 before:border-l before:border-gray-200'>
                ...
                <div className='menu-item'>
                  ...
                  >
                    <span className='menu-bullet flex w-[6px] relative before:absolute before:top-0 before:size-[6px] before:rounded-full before:-translate-x-1/2 before:-translate-y-1/2 menu-item-active:before:bg-primary menu-item-hover:before:bg-primary'></span>
                    <span className='menu-title text-2sm font-normal text-gray-800'>Leads</span>
                    <span className='menu-badge mr-[-10px]'>
                      <span className='badge badge-xs'>Soon</span>
                    </span>
                  </div>
                ...
                <div className='menu-item'>
                  ...
                  >
                    <span className='menu-bullet flex w-[6px] relative before:absolute before:top-0 before:size-[6px] before:rounded-full before:-translate-x-1/2 before:-translate-y-1/2 menu-item-active:before:bg-primary menu-item-hover:before:bg-primary'></span>
                    <span className='menu-title text-2sm font-normal text-gray-800'>Donators</span>
                    <span className='menu-badge mr-[-10px]'>
                      <span className='badge badge-xs'>Soon</span>
                    </span>
                  </div>
            ...
            <div className='menu-item'>
              ...
              >
                ...
                <span className='menu-title text-sm font-medium text-gray-800'>Projects</span>
                <span className='menu-badge mr-[-10px]'>
                  <span className='badge badge-xs'>Soon</span>
                </span>
              </div>
            ...
            <div className='menu-item'>
              ...
              >
                ...
                <span className='menu-title text-sm font-medium text-gray-800'>eCommerce</span>
                <span className='menu-badge mr-[-10px]'>
                  <span className='badge badge-xs'>Soon</span>
                </span>
              </div>
            ...
            <div className='menu-item'>
              ...
              >
                ...
                <span className='menu-title text-sm font-medium text-gray-800'>Modals</span>
                <span className='menu-badge mr-[-10px]'>
                  <span className='badge badge-xs'>Soon</span>
                </span>
              </div>
            ...
            <div className='menu-item'>
              ...
              >
                ...
                <span className='menu-title text-sm font-medium text-gray-800'>Wizards</span>
                <span className='menu-badge mr-[-10px]'>
                  <span className='badge badge-xs'>Soon</span>
                </span>
              </div>
