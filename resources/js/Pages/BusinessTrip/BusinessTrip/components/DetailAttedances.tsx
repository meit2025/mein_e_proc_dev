                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormControl>
                              ...
                              disabled={type == btEdit ? form.watch(`destinations.${destinationIndex}.detail_attedances.${index}.start_time`) : false}
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormControl>
                              <Input defaultValue={field.value} onChange={field.onChange}
                              disabled={type == btEdit ? form.watch(`destinations.${destinationIndex}.detail_attedances.${index}.end_time`) : false}/>
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
